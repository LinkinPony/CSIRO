...
└── pages/
    ├── 1_📈_Layer_Analysis.py   # Layer-wise statistics page
    ├── 2_🔍_Channel_Explorer.py # Per-channel analysis page
    ├── 3_⚠️_Outlier_Detection.py # Outlier detection page
    └── 4_📊_Comparison.py       # Comparison view page
```
